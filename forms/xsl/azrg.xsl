...
-->
      ...
      <div class="rightbar bordered padded pull-left">
        ...
        <div class="bordered centered">
          <h1>
            <xsl:value-of select="registration/car-number"/>
          </h1>
        </div>
        ...
        <div class="bordered padded" style="font-size: 18px;">
          <div class="centered">
            ...
            <em>
              <strong>Arizona Rally Group</strong> only accepts cash for payments on site!
              Discount of $10 only applies to entrants that register and pay before the online registration deadline.
            </em>
            <br/><br/>
          </div>
          Pre-Reg SCCA:
          ...
          On-Site SCCA:
          <span class="pull-right">
            $<xsl:value-of select="../../metadata/entryFees/scca_comp_onsite"/>
          </span><br/>
          On-Site Non SCCA:
          <span class="pull-right">
            $<xsl:value-of select="../../metadata/entryFees/wknd_comp_onsite"/>
          </span><br/>
        </div>
